...
/**
 * One individual query parameter.
 * @author antons
 */
public class HttpQueryParam implements ToJsonString {
    private String name;
    ...
    public static HttpQueryParam of(String name, String value) { return new HttpQueryParam(name, value); }
