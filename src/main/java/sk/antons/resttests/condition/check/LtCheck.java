...
/**
 * Check if string interpreted as number is less than given value.
 * Use form {"lt": "100"}
 * @author antons
 */
public class LtCheck extends LiteralCheck {


    public LtCheck(boolean negate) {
        super(negate);
    }
    ...
    @Override
    protected String simpleName() { return "lt"; }
